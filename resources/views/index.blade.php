            ...
            <div class="reservation-form">
                ...
                <form action="#">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <input type="number" name="person" class="form-control" placeholder="Select Persons">
                        </div>
                        <div class="col-12 col-lg-6">
                            <input type="text" name="lastname" class="form-control" placeholder="Last name">
                        </div>
                        <div class="col-12">
                            <textarea name="reservation-message" name="message" class="form-control" id="reservationMessage" cols="30" rows="10" placeholder="Your Message"></textarea>
                        </div>
                        <div class="col-12">
                            <button type="submit" name="submit" class="btn kt-btn"><span></span> Reserve Your Desk</button>
                        </div>
                    </div>
                </form>
            </div>
